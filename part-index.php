<ul id="menu">
	<!--li data-menuanchor="firstPage" class="active"><a href="#firstPage">Chave do Sucesso</a></li>
	<li data-menuanchor="secondPage"><a href="#secondPage">Funcionalidades</a></li>
	<li data-menuanchor="3rdPage"><a href="#3rdPage">Comunidade</a></li>
	<li data-menuanchor="4thpage"><a href="#4thpage">Depoimentos</a></li>
	<li data-menuanchor="5page"><a href="#5page">Breve Histórico</a></li>
	<li data-menuanchor="lastPage"><a href="#lastPage">Blog</a></li-->
	<?php if ( !is_user_logged_in() ) { ?> 
	<li>
		<a title="<?php _e("Login", "sis-foca-js"); ?>" class="abrir_login" tabindex="1">
			<!--i class="glyphicon glyphicon-log-in"></i--> 
			<span class="icon-leg"><?php _e("Login", "sis-foca-js"); ?></span>
		</a>
	</li>
	<li>
		<a href="/register" role="button" aria-pressed="true" title="<?php _e("Create your free pomodoros.com.br account", "sis-foca-js"); ?>" class="btn-success">
			<i class="glyphicon glyphicon-star"></i> 
			<span class="icon-leg"><?php _e("Sign Up", "sis-foca-js"); ?></span>
		</a>
	</li>
	<?php } else { ?>
		<li class="pomodoros-logo">
