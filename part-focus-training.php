...
<div class="content_nosidebar col-xs-12 col-sm-6" style="width: 104%;left: -2%;" >
	...
	<p class="bg-success" style="margin:0 60px; font-size: 14px; padding:20px; text-align: center;"><a href="https://www.treinamentoemfoco.com.br"><?php _e("Focus Training", "sis-foca-js"); ?>: <?php _e("Be more productive", "sis-foca-js"); ?></a><p>
